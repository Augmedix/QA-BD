...
def send_create_patient_requset(patient_creation_url, patient_name, pst_time, pst_date, jwt_token):
    ...
    url = patient_creation_url + '/providers/me/patients?patientName=' + patient_name + '&startTime='\
        + pst_time + '&visitDate=' + pst_date
...
def create_patient(patient_creation_url, patient_name, token):
    ...
    resp = send_create_patient_requset(patient_creation_url, patient_name, time[0], date, token)
    return resp, time[1]
