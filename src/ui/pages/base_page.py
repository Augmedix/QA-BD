...
class BasePage:
    ...
    def get_attribute(self, locator, attribute):
        return self.get_element(locator, 5).get_attribute(attribute).strip()
    ...
    def hover_element(self, by_element):
    ...
    def is_element_visible(self, locator, wait_time=60):
        ...
        if isinstance(locator, WebElement):
            try:
                self.wait_for_expected_condition(
                    EC.visibility_of(locator), wait_time)
                return True
            except TimeoutException:
                return False
        try:
    ...
    # def get_background_color_in_hex(self, locator):
    #     return convert_rgba_to_hex(self.get_background_color(locator))

    # def get_border_color(self, locator):
    #     return self.get_css_value(locator, 'border-color')

    # def get_border_color_in_hex(self, locator):
    #     return convert_rgba_to_hex(self.get_border_color(locator))
